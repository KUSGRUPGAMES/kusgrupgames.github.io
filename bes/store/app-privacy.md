...
> Paket kimliği yayınlandıktan sonra **değiştirilemez** — mağazada uygulamanın
> kimliğidir. Konsolda uygulamayı açarken buradaki değeri birebir kopyala.
...
Android derleme akışı (`.github/workflows/bes-android.yml`) birleştirilmiş
manifest'i denetler.
