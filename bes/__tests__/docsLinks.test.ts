 ...
 *
 * `brand.json` içindeki `termsUrl`, `docs/bes/terms.html` adresini
 ...
 *  1. `docs/bes/` içindeki her yerel bağlantı gerçekten bir dosyaya gider.
...
const DOCS = join(__dirname, '..', '..', 'docs', 'bes');
