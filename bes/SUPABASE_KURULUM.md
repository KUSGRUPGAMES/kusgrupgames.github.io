...
3. `Authentication` → `URL Configuration`:
   - **Site URL:** `https://kusgrupgames.github.io/bes/`
   - **Redirect URLs** listesine şunu ekle: `bes://auth-callback`
...
**Uygulama**
- Supabase istemcisi, oturum yönetimi ve derin bağlantı (`bes://auth-callback`)
