...
- [x] `docs/bes/content/tr.json` sürüm 1; içerik kanalı v1'de hiçbir ekrana
...
- [x] Gizlilik sayfası hazır: `docs/bes/privacy.html` ve `gizlilik.html` *(Pages'te görünmesi için dal `main`'e birleşmeli)*
